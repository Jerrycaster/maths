...
\newcommand{\Homeo}[1]{\text{Homeo}(#1)}
\newcommand{\calP}{\mathcal{P}}
\newcommand{\calQ}{\mathcal{Q}}
\newcommand{\upint}{\overline{\int_a^b}f(x)\text{d}x}
\newcommand{\lowint}{\underline{\int_a^b}f(x)\text{d}x}
...
\subfile{03-manifolds.tex}

\newpage
\section{Additional Topics}\label{sec:4}
\subfile{04-topics.tex}
